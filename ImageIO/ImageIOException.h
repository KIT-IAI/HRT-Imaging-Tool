...
public:
	...
	EReason eReason;
	std::wstring sAdditionalInfo;
	std::string sCompleteErrorMessage;
private:
	static std::string GetExceptionMessage(const CImageIOException& ex);
