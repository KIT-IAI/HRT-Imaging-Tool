...
CSNPDatasetParameters HRTImagingToolParameterDialog::CreateDefaults()
{
	...
	parameters.bVignettingCorrectionBeforeRegistration = false;
	parameters.sVignettingFileBeforeRegistration = L"";
	parameters.nVignettingSmoothingBeforeRegistration = 0;
	parameters.eStrategie = ERegistrationStrategy::ePositionBased;
	...
	parameters.eProcessType = CProcessType::eHRTStreamRegistration;
	parameters.fMinScore = 4.5;
	parameters.fMinScoreFlexible = 9.0;
	parameters.fCertainScore = 20.0;
	parameters.fScalation = 1.0;
	parameters.fScalationSubImages = 1.0;
	...
	parameters.bVignettingCorrectionBeforeCompositing = false;
