...
void CRegStepResidualFilter::ProcessRegistrationData(vector<StlImage<float>*>& /*images*/, vector<CRegistrationResult>& validRegistrationResults, vector<CRegistrationResult>& invalidRegistrationResults, vector<std::list<size_t>>& imagegroups)
{
