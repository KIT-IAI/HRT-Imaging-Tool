...
public:
	...
	static CResidual CreateFromSubimageRegistration(const CRigidRegistrationResult& reg, const CDenseMatrix& subImagePositions, size_t subImageHeight, size_t subPerImg);
