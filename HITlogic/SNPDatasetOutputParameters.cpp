...
CSNPDatasetOutputParameters CSNPDatasetOutputParameters::ConstructWithCurrentUserdata()
{
...
bool CSNPDatasetOutputParameters::operator==(const CSNPDatasetOutputParameters& rhs) const
{
	return nImageCount == rhs.nImageCount
		&& ImageParameters == rhs.ImageParameters
		&& nDetectedImageGroups == rhs.nDetectedImageGroups
		&& fDetectedThreshold == rhs.fDetectedThreshold;
}
